...
public class Student extends User {
    ...
    //Here the deletePost method is utilized for parameters forum and post. Throws the util.NoPermissionException.
...
//Here the addReply method is utilized for the parameters post and reply. Adding a reply to a discussion post is synchronized.
    ...
    //Here the createForum method is utilized for parameters course and topic. This throws the util.NoPermissionException which denies students to create forums.
    ...
    //Here the deleteForum method is utilized for parameters course and forum. This throws the util.NoPermissionException which denies students to delete forums.
    ...
    //Here the editForum method is utilized for parameters course, forum, and topic. This throws the util.NoPermissionException which denies students to edit forums.
    @Override
    public void editForum(Course course, DiscussionForum forum, String topic) throws NoPermissionException {
        throw new NoPermissionException();
    }

    //Here the createCourse method is utilized for the parameter courseTitle. This throws the util.NoPermissionException which denies students to create courses.
    @Override
    public void createCourse(String courseTitle) throws NoPermissionException {
        throw new NoPermissionException();
    }

    //Here the deleteCourse method is utilized for parameter course. This throws the util.NoPermissionException which denies students to delete courses.
    ...
    //Here the editCourse method is utilized for parameters courseTitle. This throws the util.NoPermissionException which denies students to createForums.
    @Override
    public void editCourse(Course course, String courseTitle) throws NoPermissionException {
        throw new NoPermissionException();
    }

    //Here the vote method is utilized for parameters forum and post. This throws the util.AlreadyVotedException which informs students that they have already voted.
